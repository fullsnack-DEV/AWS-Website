...
export default {
  ...
  noReservationFountText: 'th_No Reservations Found',
  // member connection
  ...
  totalGames: 'th_game',
  message: 'th_Message',
  followSportTeam: 'th_Follow sport Teams.',
  follow: 'th_Follow',
  ...
  passwordSamevalidation:
    'th_New Password and Confirm Password should be same.',
  ...
  sportActivityText: 'th_Sports Activities',
