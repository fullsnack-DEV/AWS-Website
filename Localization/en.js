...
export default {
  ...
  whoCanJoinYourTeam: 'en_Who can join your team?',
  ...
  editChatRoom: 'en_Edit ChatRoom Photo & Name',
  ...
  noActivityLog: 'en_No Activity Log',
  hereinString: 'en_Here in the',
  townsCupApp: 'en_TownsCup app',
  youCanView: 'en_you can view:',
  tournaments: 'en_tournaments',
  leaguesText: 'en_Leagues',
  playersText: 'en_Players',
  refreesText: 'en_Referees',
  scorekeepersText: 'en_Scorekeepers',
  rankingsText: 'en_rankings',
  weAreNewText: 'en_We are new',
  inYourTown: 'en_in your town',
  helpUsFooterTest:
    'en_ Help us to build a wonderful sport community in your town.',
  ...
  unavailableText: 'en_Unavailable',
  noUpcomingEventToShow: 'en_No Upcoming event to Show',
  newUpcomingEventOccurHere: 'en_New upcoming event will appear here.',
  noCompletedEventToShow: 'en_No Completed event to Show',
  newCompletedEventOccurHere: 'en_New completed event will appear here.',
  ...
  advancedSettings: 'en_Advanced Settings',
  likeCount: 'en_Like count',
  commenting: 'en_Commenting',
  reposting: 'en_Reposting',
  onText: 'en_On',
  offText: 'en_Off',
  unhide: 'en_Unhide',
  hideLikeCount: 'en_Hide like count',
  unhideLikeCount: 'en_Unhide like count',
  turnOffCommenting: 'en_Turn off commenting',
  turnOnCommenting: 'en_Turn on commenting',
  turnOffResposting: 'en_Turn off reposting',
  turnOnReposting: 'en_Turn on reposting',
  deletePost: 'en_Delete post',
  ...
  whoCanSeeItemsOfBasicInfo:
    'en_Who can see the following items of your basic info?',
  theseSettingsWillBeAppliedForBasicInfo:
    'en_These settings will be applied to all screens where your basic info is displayed.',
  noPostsToShow: 'en_No posts to show',
  noEventsToShow: 'en_No events to show',
  noPhotosAndVideosToShow: 'en_No photos & videos to show',
  noMatchesToShow: 'en_No matches to show',
  noFollowersToShow: 'en_No followers to show',
  noFollowingsToShow: 'en_No followings to show',
  noMembersToShow: 'en_No members to show',
