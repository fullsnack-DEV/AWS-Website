export default {
  ...
  whoCanJounGroupText: 'Who can join the {0}?',
  ...
  cancelInvoiceText: 'en_Cancel Invoices',
  ...
  whoCanJoinGroupText: 'Who Can Join {0}',
  ...
  inviteYouToJoinEventText: 'invited you to join the event.',
  ...
  emailNotRegisterdValidation: 'This email address is not registerd',
  emailAlreadyRegisteredValidation:
    'That email address is already registrated! please login',
  manyRequestForSignUpValidation:
    'Too many request for signup ,try after sometime',
  emailAlreadyRegisteredWith: 'This email is already registrated with {0}',
  ...
  whoCanSeeMembersText: 'Who can see members in {0} connections?',
  ...
  whouldYouLikeToConnectText:
    "Would you like to connect this user’s account to {0}'s profile in your team?",
  ...
  groupMembersText: '{0} & members',
  groupOnlyText: '{0} only',
  canInviteYouText: 'Can {0} Invite You',

  whoCanCreateYourEventText: 'Who can create your {0} event?',
  errorCodeText: 'Error code: {0}',

  canInviteYouToJoinText: 'Can a {0} invite you to join the {1}?',
  recruitingPlayerText: 'en_Recruiting Player',
  areYouSureLeaveText: 'Are you sure your team wants to leave {0}?',
  leave: 'en_Leave',
  ...
  whoCanInviteMemberToText: 'Who can invite a member to {0}?',
  ...
  duedate: 'en_Due Date',
  lessThan1AmountValidation: 'User should not allow less than $1 amount.',
  moreThanInvoiceAmountValidation:
    'User should not allow more than invoice amount.',
  notRefundMorethanInvoiceValication:
    'User should not refund more than invoice paid amount.',

  invoiceNoteValidation: 'Please select invoice note.',
  cancelInvoiceAlertText: 'Are you sure that you want to cancel {0} invoice?',
  ...
  total00: 'en_00.00',
  transactionNumberText: 'en_Transaction no.:',
  ...
  daily: 'Daily',
  weeklyText: 'Weekly',
  monthlyOnText: 'Monthly on {0}',
  monthlyOnDayText: 'Monthly on {0} day',
  yearly: 'Yearly',
  never: 'Never',
  ...
  pauseUnpauseAccountText: 'Are you sure you want to {0} this account?',
  unpause: 'en_Unpause',
  ...
  lookingForClubText: 'Looking For Club',
  lookingForTeamText: 'Looking For Team',
  deactivateActivityText: 'Deactivate This Activity',
  ...
  chooseOneSportText: 'Please choose at least one sport.',
  noregisterdSportValication: 'There is no registerd sports.',
  completeProfile: 'completed user profile',
  ...
  emailNotVerifiedText: 'Your email hasn’t been verified yet.',
  ...
  sportActivityText: 'Sports Activities',
  timezoneText: 'Time Zone',
  currencyText: 'Currency',
  deactivateAccountText: 'Deactivate Account',
  terminateAccountText: 'Terminate Account',
  challengeSettingText: 'Challenge Settings',
  reservationSettingText: 'Reservation Settings',
  teamRequestCancelledText: 'Your team request cancelled.',
  ...
  logOut: 'Log out',
  teamCreateClubsText: 'When your team creates a club:',
  yourTeamWillBelogText: '\n• your team will belong to the club initially.',
  teamCanLeaveClubText: '\n• your team can leave the club anytime later.',
  ...
  thisFeatureisUnderDevelopment: 'This feature is in development.',
  ...
  verifyEmailText: 'Please verify your email.',
  sentVerificationEmailAfterSecond:
    'YOU CAN SEND VERIFICATION EMAIL AGAIN AFTER {0} SECONDS.',
  sentEmailAgainTExt: 'SEND VERIFICATION EMAIL AGAIN',
  iHaveVerifiedEmail: 'I’VE VERIFIED MY EMAIL ADDRESS',
  LOGIN: 'LOG IN',

  manyRequestForLogin: 'Too many request for login ,try after sometime',
  somethingWentWrongText: 'Something went wrong obtaining access token',
  cancelLoginProcess: 'User canceled the login process',
  inProgress: 'in progress',
  playServiceNotAvailable: 'play services not available or outdated',
  signInCancelled: 'Sign in process cancelled.',
  appleLoginNotSupported: 'Apple Login not supported',
  appleSignInFailed: 'Apple Sign-In failed - no identify token returned',
  signUpCouldNotCompleted: 'Your sign up could not be completed.',
  byCountinueSignUp: 'By continuing or signing up you agree to our',
  ...
  cancellationPolicyText:
    'When you cancel this game reservation before 3:55pm on August 11, you will get a 50% refund, minus the service fee. ',
  ...
  cancelGameReservationBefore:
    'When you cancel this game reservation before {} on {}, you will get a {2}% refund, minus the service fee.',

  cancelGameReservationMinusFee:
    'When you cancel this game reservation before {0} on {1}, you will get a {2}% refund, minus the service fee.',

  challengeSentText: 'en_Challenge sent',
  whenGroupNotifyText:
    'When {0} accepts your match reservation request, you will be notified.',
  ...
  betweenScheduledDesc: 'and {0} has been scheduled.',
  ...
  teamConfirmScorekeeperReservation:
    'Your team has the confirmed scorekeeper reservation for {0}.',
  ...
  hoursMinutesText: '{0} Hours {1} Minutes',
  ...
  nOverTime: '{0} Overtime',
  addIntervalPeriod: '+ Add Interval & Period',
  hmTime: '{0}h {1}m',
  ...
  requestExpiredFrom:
    'The match reservation request from {0} has been expired.',
  sentRequestToDate:
    '{0} sent a match reservation request to {1}. This request will be expired in',
  receivedRequestToDate:
    '{0} received a match reservation request from {1}. This request will be expired in',
  paymentGoesWith:
  ...
  refereesScorekeepersText:
    'The match place, referees and scorekeepers should be secured by the team who has charge of them at its own expense.',
  refereeApprovalRequestSent: 'en_Referee approval request sent.',
  refereeText: 'en_Referee',

  chiefRefereeValidation: 'You can’t book the chief referee for this game.',
  cannotBookMoreThanReferee:
    'You can’t book more than {0} assistant referees for this game. You can change the number of referees in the reservation details.',

  refereeSettingNotConfigureValidation:
    'en_Referee setting not configured yet.',
  canNotBookMoreThanreferee:
    "You can't book more than {0} referee for this match. You can change the number of referees in the reservation details.",
  ...
  refereeBookingSent: 'Referee booking request\nsent.',
  scorekeeperBookingSent: 'Scorekeeper booking request\nsent.',
  ...
  let: 'en_Let',
  scorePoint: 'score a point',
  smackedAnAce: 'smacked an ace',
  markedWinner: 'marked as a winner',
  unforcedError: 'done an unforced error',
  commitFeetFault: 'committed a feet fault',
  commitFault: 'committed a fault',
  commitLet: 'committed a let',
  doYouWantChangeServing: 'Do you want to change the serving player?',
  setScore: 'SET SCORES',
  endText: 'End',
  PERIOD: 'PERIOD',

  gameReservationDetail: 'Game Reservation Detail',
  addSetOrGame: 'Add Set or Game',
  ...
  yourReviewWillDisplayDesc:
    'Your reviews will be displayed after the review period expires or all {0}, referees, scorekeepers complete their reviews.',
  addGame: '+ Add game',
  addSet: '+ Add Set',
  notEnded: 'Not Ended',
  starttimeGreterEndTime: 'Start time should be greter than end time',
  matchRecords: 'en_Match records',

  yourTeamDontLineup: 'Your team does not configure lineup yet.',
  awayTeamDoesNotHaveLineup: 'Away team does not configure lineup yet.',
  addASet: 'Add a set',

  chooseStartEndTime: 'Choose the starting and ending time of the new set.',
  chooseStartEndTimeGame:
    'Choose the starting and ending time of the new Game.',
  whenAddingNewSet:
  ...
  deactivatedSportsActivities: 'Deactivated Sports Acitivies',
  whoCanSeeCategory: 'Who can see each category in Basic Info?',
  completedNGame: 'Completed ({0})',
  upcomingNGame: 'Upcoming ({0})',
  monthlyMatches: 'Monthly Matches',
  totalMatches: 'Total Matches',
  draws: 'Draws',
  losses: 'Losses',
  winningPercentage: 'Winning\nPercentage',
  statsPerGame: 'STATS Per game ( 5 sets )',
  detailInfoRating: 'Detail info about ratings',

  totalText: 'Total',
  matchTime: 'Match Time',
  win: 'Win',
  RDMPercentage: 'RDM Percentage',
  RDMRT: 'RDMs/R&Ts',
  RDMs: 'RDMs',
  RTs: 'R&Ts',
  RDMTotalMatches: '(RDMs + Total Matches)',
  resultDisapprovedMatches: '(Result-Dissapproved Matches)',
  TCPerGame: 'STATS Per game ( 3 sets )',
  wins: 'Wins',
  lookingNewTeam:
  ...
  hasBeenCreated: 'rn_has been created.',
  ...
  addSportActivity: 'Add New Sports Activity',
  sportActivityTagOrder: 'sports Activity Tags Order',
  listUnlist: 'List / Unlist',
