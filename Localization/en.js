export default {
  ...
  injuredPlaceholder: 'Injured',
  longTermAwayPlaceholder: 'Long-term Away',
  suspendedPlaceholder: 'Suspended',
  ...
  height: 'Height',
  weight: 'Weight',
  heightTypeText: 'Height type',
  weightTypeText: 'Weight type',
  cm: 'cm',
  ft: 'ft',
  kg: 'kg',
  pound: 'pound',
  ...
  noMembersText: 'No members',
  noMebersFoundText: 'No Members Found',
  sport: 'Sport',
  hometown: 'Home town',
  ...
  validEmailValidation: 'Please enter valid email address.',
  heightValidation: 'Please select height measurement',
  validHeightValidation: 'Please enter valid height.',
  weightValidation: 'Please select weight measurement',
  validWeightValidation: 'Please enter valid weight.',
  ...
  moreText: 'more',
  noShortsText: 'NO SHORTS',
  postShortsText: 'Post your short >',
  noPlayerTeamText: 'NO AVAILABLE TEAMS OR PLAYERS',
  noPostFoundText: 'No Post Found',
  feedTitleText: 'Feed',
  everyoneTitleText: 'Everyone',
  onlymeTitleText: 'Only me',
  followerTitleText: 'Followers',
  memberInGroupText: 'Members in my groups',
  writeTextOrImage: 'Please write some text or select any image.',
  privacySettingText: 'Privacy Setting',
  feeTitleText: 'Fee',
  enterHeightText: 'Enter Height',
  enterWeightText: 'Enter Weight',
  rightWord: 'Right',
  leftWord: 'Left',
  poseWord: 'Pose',
  selectMostUsedFootText: 'Select Most Used Foot',
  dollerSign: '$',

  editBioText: 'Edit Bio',
  editBasicInfoText: 'Edit Basic Info',
  editFeeText: 'Edit Fee',
  editNTRPText: 'Edit NTRP',
  editHomePlaceText: 'Edit Home Place',
  editCertificateText: 'Edit Certificates',
  editPolicyText: 'Edit Policy',

  englishLangText: 'English',
  englishCanadaLangText: 'English(Canada)',
  englishSingaporeLangText: 'English(Singapore)',
  englishUKLangText: 'English(UK)',
  englishUSLangText: 'English(US)',
  deutschLangText: 'Deutsch',
  italianoLangText: 'Italiano',
  koreanLangText: 'Korean',
  cadPerHourText: 'CAD/hours',
  availableAreaText: 'Available Area',
  noAreaFoundText: 'No Area found',
  noSettingConfigureText: 'No Setting Configured Yet',
  editTitleText: 'Edit',
  policyTitleText: 'Policy',
  titleAndPhotosText: 'Title and photos',
  certificateNameText: 'Please Enter Certificate Name!',
  selectCertificateImageText: 'Please Select Certificate Image!',
  editlanguagesText: 'Edit Languages',
  noRecordFoundText: 'No Records Found',
  noCertificateFoundText: 'No certificates found',
  withInText: 'Within',
  ofText: 'of',
  generalText: 'General',
  peopleTitleText: 'People',
  groupsTitleText: 'Groups',
  gamesTitleText: 'Games',
  postsTitleText: 'Posts',
  teamsTitleText: 'Teams',
  clubsTitleText: 'Clubs',
  leaguesTitleText: 'Leagues',
  worldTitleText: 'world',
  completedTitleText: 'Completed',
  upcomingTitleText: 'Upcoming',
  videosTitleText: 'Videos',
  photosTitleText: 'Photos',
  gameIDNotExitsTitle: 'Game ID does not exist.',
  homeCityTitleText: 'Home City',
  selectSportTitleText: 'Select Sport',
  toText: 'To',
  fromText: 'From',
  timezoneTitleText: 'Time zone',
  areYouSureRemoveFilterText: 'Are you sure want to reset filters?',
  okTitleText: 'OK',
  resetTitleText: 'Reset',
  reservationsTitleText: 'Reservations',
  playingTitleText: 'Playing',
  refereeingTitleText: 'Refereeing',
  scorekeepingTitleText: 'Scorekeeping',
  addSportsTitle: 'Add a sport',
  registerRefereeTitle: 'Register as Referee',
  registerScorekeeperTitle: 'Register as Scorekeeper',
  createTeamText: 'Create Team',
  createClubText: 'Create Club',
  createLeagueText: 'Create a League',
  paymentPayoutText: 'Payment & Payout',
  paymentMethodTitle: 'Payment Method',
  payoutMethodTitle: 'Payout Method',
  invoicesTitle: 'Invoices',
  transactionsTitles: 'Transactions',
  settingsTitleText: 'Settings',
  invoicingTitleText: 'Invoicing',
  appLanguage: 'App Language',
  useDeviceLangTitle: 'Use Device Language',
  linkedCopied: 'Link Copied!',
  enterThreeCharText: 'Please enter atleast 3 characters to see city',
  remove: 'Remove',
  noTabsFoundText_dy: 'No {0} Found',
  entityCreatedText_dy: '{0}\nhas been created.',
  sportsTitleText: 'Sports',
  locationTitleText: 'Location',
  ...
  requestDeclinedText: 'This request is already declined.',
  requestDeletedText: 'This request is already deleted.',
  requestAcceptedText: 'This request is already accepted.',
  requestNotValidText: 'This request is not valid now.',
  requestStatusNotText: 'status not defined',
  goToTeamHomeText: 'Go to team home',
  teamMemberShipText: 'Team Membership & Admin Authority',
  nameCanNotBlankText: 'First name cannot be blank',
  lastNameCanNotBlankText: 'Last name cannot be blank',
  emailNotBlankText: 'Email cannot be blank',
  ...
  sendRequestText: 'Send request for basic info',
  collectMemberInfoText:
    'You can send a request to collect a member’s basic info. When it is accepted, this basic info will be updated with the information provided by the member.',

  adminAuthorityText: 'Admin Authority And Role',
  syncInfoText: 'Sync Info',
  importMembersText:
    'How do you like to update a member’s profile by Importing member’s account info?',
  manually: 'Mannually',
  automatically: 'Automatically',
  clickSyncButtonText:
    'A member’s profile is updated when you click the “sync Info” button in each member’s profile.',

  autoSyncInfoText:
    'A member’s profile is updated every time a member changes his or her account info.',
  eachteamSettingNote: '* Each team settings prevails over the club settings.',
  connectionRequestSentText: 'Connection request sent',
  accountConnectText:
    'When {0} {1} accepts the request, the user’s account will be connected to the member’s profile created in your group.',

  selectOneMemberText: 'Please select one member for connect with profile.',

  inviteBySearchText: 'Invite by Search',
  inviteEmailtext: 'Invite by E-mail',

  groupMessageText: 'Group Message',
  inviteMemberText: 'Invite Member',
  createMemberProfileText: 'Create Member Profile',
  connectMemberAccountText: 'Connect Member Account',
  sendrequestForBaicInfoText: 'Send Request For Basic Info',
  setting: 'Setting',
  noPlayer: 'No Players',
  youCanNotAddMoreEmailText: 'You can not add more than 10 email id.',
  send: 'Send',
  fillAllEmailText: 'Please fill all email fields.',
  configureEmailAccounttext: 'Please configure email in your device',
