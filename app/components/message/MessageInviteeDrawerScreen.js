...
const MessageInviteeDrawerScreen = ({
  ...
  console.log('participantsparticipants', commentModalRef);
  useEffect(() => {
    const getUser = async () => {
  ...
  const inviteButton = useMemo(
    () =>
      dialog?.dialogType === QB.chat.DIALOG_TYPE.GROUP_CHAT && (
        <View>
          <TouchableOpacity
    ...
    [commentModalRef, dialog, myUserId, navigation, onPressDone, participants],
  );
  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      <View style={styles.viewContainer}>
        ...
        <View style={{flex: 1, height: hp(30)}}></View>
