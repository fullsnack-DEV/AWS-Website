      ...
      <View style={styles.topViewContainer}>
        ...
        {userData.profile.user_id !== authContext.entity.obj.user_id && <View style={styles.buttonStyle}>
          <TouchableOpacity onPress={() => {
            ...
            navigation.navigate('PlayerReviewScreen', { userData, sliderAttributesForPlayer: route?.params?.sliderAttributesForPlayer, starAttributesForPlayer: route?.params?.starAttributesForPlayer })
          }}>
            <LinearGradient
