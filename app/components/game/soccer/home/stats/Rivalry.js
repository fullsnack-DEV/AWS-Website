    ...
    <View>
      <View style={styles.mainContainer}>
        ...
        <TCWinningRangeChart
          ...
          teamOneCount={
            rivalryData?.all?.team_id === gameData?.home_team?.group_id
              ? rivalryData?.all?.result?.win
              : 0
          }
          teamTwoCount={
            rivalryData?.all?.opp_team_id === gameData?.away_team?.group_id
        ...
        <TCWinningRangeChart
          ...
          teamOneCount={
            rivalryData?.homeGames[0]?.team_id === gameData?.home_team?.group_id
        ...
        <TCWinningRangeChart
          ...
          teamTwoCount={
            rivalryData?.homeGames[1]?.team_id === gameData?.away_team?.group_id
