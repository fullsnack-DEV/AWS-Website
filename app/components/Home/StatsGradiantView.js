...
export default function StatsGradiantView({
  ...
  return (
    <TouchableOpacity style={styles.containerStyle} onPress={onItemPress}>
      ...
      >
        <Image source={sourceImage} style={[styles.imageViewStyle, imageViewStyle]} resizeMode={'contain'} />
      ...
      >
        <Text style={[styles.counterTextStyle, counterTextStyle]}>{counterNumber}</Text>
      </LinearGradient>
    </TouchableOpacity>
  );
}
