    ...
    const sportsView = useCallback(({item}) => {
      ...
      return (
        <View style={styles.sportView}>
          <LinearGradient
            colors={item?.type === 'player' && [colors.yellowColor, colors.orangeGradientColor] || item?.type === 'referee' && [colors.yellowColor, colors.darkThemeColor] || item?.type === 'scorekeeper' && [colors.blueGradiantEnd, colors.blueGradiantStart]}
