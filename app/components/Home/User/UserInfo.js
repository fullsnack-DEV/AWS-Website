  ...
  return (
    <View>
      ...
      <View style={styles.sectionStyle}>
        <TCEditHeader title= {strings.abouttitle} showEditButton={isAdmin}
          onEditPress={() => {
      ...
      <View style={styles.sectionStyle}>
        ...
        <TCInfoField title={strings.emailtitle} value={email} marginLeft={10} marginTop={20}/>
        <TCInfoField title={strings.phone} value={phone} marginLeft={10}/>
        <TCInfoField title={strings.addressPlaceholder} value={address} marginLeft={10}/>
