...
function ScorekeeperEntityView({data}) {
  console.log('scorekeeperEntityView:=>', data);
      ...
      <View
        ...
        <View style={styles.entityView}>
          <View style={styles.imageShadowView}>
            <Image
              source={
                data?.scorekeeper?.thumbnail
                  ? {uri: data?.scorekeeper?.thumbnail}
          ...
          <View style={{flex: 0.75, flexDirection: 'row'}}>
            <Text style={styles.entityName} numberOfLines={1}>
              {`${data?.scorekeeper?.first_name} ${data?.scorekeeper?.last_name}`}
            </Text>
          </View>
        </View>
      </View>
...
export default memo(ScorekeeperEntityView);
