...
const TCGameDetailRules = ({gameRules,isMore = true,onPressMoreLess,isShowTitle = true}) => {
    ...
    <View style={{marginTop: 10}}>
      ...
      {isMore && <View>
        ...
        style={{
          ...
          <Text style={styles.subRulesTitle}>{gameRules?.match_duration}</Text>
        </View>
      ...
      <Text style={[styles.lightSubTitle,{textAlign:'right',marginRight:15}]} onPress={onPressMoreLess}>{isMore ?  'less' : 'more'}</Text>
    </View>
  );
};
