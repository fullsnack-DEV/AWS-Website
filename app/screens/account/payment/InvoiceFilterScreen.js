...
import React, {
  ...
  console.log('Status', status);
     ...
     if (status === 'All') {
      ...
      console.log('memberList', memberList.filter((obj) => obj.invoices.invoice_status === 'Paid'));

       return memberList.filter((obj) => obj.invoices.invoice_status === 'Paid')
     } if (status === 'Open') {
      console.log('memberList', memberList.filter((obj) => (obj.invoices.invoice_status === 'Unpaid')));

      return memberList.filter((obj) => (obj.invoices.invoice_status === 'Unpaid' || obj.invoices.invoice_status === 'Partially Paid'))
    }
    }
    return (
