import React, {
   ...
   export default function AvailibilityScorekeeoer({ navigation, route }) {
     ...
     const [acceptChallenge, setAcceptChallenge] = useState(route?.params?.settingObj?.scorekeeperAvailibility ? route?.params?.settingObj?.scorekeeperAvailibility === 'On' : true);
     ...
     return (
       ...
       <SafeAreaView>
         ...
         <View>
           ...
           <TCLabel title={strings.availibilityScorekeeperTitle} style={{ marginRight: 15 }} />
