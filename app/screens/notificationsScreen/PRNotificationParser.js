...
export const parseRequest = async (data, selectedEntity, loggedInEntity) => {
  ...
  || data.activities[0].verb.includes(NotificationType.scorekeeperReservationAwaitingPaymentPaid)
  || data.activities[0].verb.includes(NotificationType.scorekeeperReservationAutoCanceledDueToInitialPaymentFailed)
  || data.activities[0].verb.includes(NotificationType.scorekeeperReservationAutoRestoredDueToAlterPaymentFailed)
  || data.activities[0].verb.includes(NotificationType.scorekeeperReservationCanceledDuringAwaitingPayment)
  || data.activities[0].verb.includes(NotificationType.scorekeeperReservationRestoredDuringAwaitingPayment)) {
