    ...
    const topRightButton = useMemo(() => (
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        <TouchableOpacity onPress={() => {}}>
          <FastImage source={images.scheduleThreeDot} resizeMode={'contain'} style={styles.rightImageStyle} />
        </TouchableOpacity>
      </View>
    ), [])
      ...
      <Header
            ...
            leftComponent={
              <TouchableOpacity onPress={() => navigation.goBack()}>
                <Image source={images.backArrow} style={styles.backImageStyle} resizeMode={'contain'} />
              </TouchableOpacity>
            }
            centerComponent={
