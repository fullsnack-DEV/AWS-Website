...
import ScorekeeperReservationStatus from '../../Constants/ScorekeeperReservationStatus';
 ...
 export default function ScorekeeperApprovalScreen({ navigation, route }) {
   ...
   const approveReservation = (reservationID) => {
     setloading(true);
     acceptDeclineReservation('scorekeepers', reservationID, authContext.entity.uid, reservationObj.version, type, {}, authContext)
       .then((response) => {
         setloading(false);
   ...
   const disApproveReservation = (reservationID) => {
     setloading(true);
     acceptDeclineReservation('scorekeepers', reservationID, authContext.entity.uid, reservationObj.version, 'decline', {}, authContext)
       .then((response) => {
         setloading(false);
