...
export const postMultiElasticSearch = async (query) =>
  makeElasticAPIRequest({
    method: 'post',
...
export const getGameIndex = async (query) =>
  makeElasticAPIRequest({
    method: 'post',
...
export const getUserIndex = async (query) =>
  makeElasticAPIRequest({
    method: 'post',
...
export const getGroupIndex = async (query) =>
  makeElasticAPIRequest({
    method: 'post',
...
export const getCalendarIndex = async (query) =>
  makeElasticAPIRequest({
    method: 'post',
...
export const getGamesListIndex = async () =>
  makeElasticAPIRequest({
    method: 'get',
    url: `/${Config.GAME_INDEX}/_search`,
  });

export const getEntityIndex = async (query) =>
  makeElasticAPIRequest({
    method: 'post',
