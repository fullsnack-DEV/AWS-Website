...
export const getFeesEstimation = async (params, authContext) =>
  makeAPIRequest({
    method: 'post',
...
export const getEntityFeesEstimation = async (
...
export const payAgainAlter = async (challengeID, params, authContext) =>
  makeAPIRequest({
    method: 'post',
...
export const payAgain = async (challengeID, params, authContext) =>
  makeAPIRequest({
    method: 'post',
...
export const payAgainAlterReferee = async (
  reservationID,
  params,
  authContext,
) =>
...
export const payAgainReferee = async (reservationID, params, authContext) =>
  makeAPIRequest({
    method: 'post',
...
export const payAgainAlterScorekeeper = async (
  reservationID,
  params,
  authContext,
) =>
...
export const payAgainScorekeeper = async (reservationID, params, authContext) =>
  makeAPIRequest({
    method: 'post',
...
export const createChallenge = async (params, authContext) =>
  makeAPIRequest({
    method: 'post',
...
export const getChallenge = async (challengeId, authContext) =>
  makeAPIRequest({
    method: 'get',
...
export const acceptDeclineChallenge = async (
  teamId,
  challengeId,
  versionNo,
  status,
...
export const acceptDeclineReservation = async (
  reservationEntityType,
  reservationID,
  callerID,
  versionNo,
...
export const acceptDeclineAlterReservation = async (
  reservationEntityType,
  reservationID,
  callerID,
  versionNo,
...
export const cancelAlterReservation = async (
  reservationEntityType,
  reservationID,
  callerID,
  versionNo,
...
export const acceptDeclineAlterChallenge = async (
  teamId,
  challengeId,
  versionNo,
  status,
...
export const updateChallenge = async (challengeId, params, authContext) =>
  makeAPIRequest({
    method: 'patch',
...
export const getRefereeGameFeeEstimation = async (
  entityID,
  params,
  authContext,
) =>
...
export const getScorekeeperGameFeeEstimation = async (
  entityID,
  params,
  authContext,
) =>
...
export const getChallengeSetting = async (
  entityId,
  sport,
  entityType,
  authContext,
