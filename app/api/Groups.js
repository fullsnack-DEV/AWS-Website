...
export const getGroupSearch = (name, city, teamID, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/groups/exist?group_name=${name}&city=${city}&team_id=${teamID}`,
  authContext,
})

export const getGroupName = (name, city, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/groups/exist?group_name=${name}&city=${city}`,
  authContext,
})

export const getGroupRequest = (requestType, groupID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/groups/request/${requestType}/${groupID}`,
  authContext,
})
...
//     method: 'get',
//     url: `${BASE_URL}groups/joined${query}`,
//     authContext,
//   })
// }
...
export const getGroupMembersInfo = (groupID, memberID, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}groups/${groupID}/members/${memberID}`,
  authContext,
})

export const connectProfile = (groupID, memberID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}groups/${groupID}/members/${memberID}/connect`,
  authContext,
})
...
export const followGroup = (params, groupID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/groups/${groupID}/follow`,
  data: params,
  authContext,
});
...
export const unfollowGroup = (params, groupID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/groups/${groupID}/unfollow`,
  data: params,
  authContext,
});
...
export const inviteTeam = (params, groupID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/groups/${groupID}/inviteTeams`,
  data: params,
  authContext,
});
