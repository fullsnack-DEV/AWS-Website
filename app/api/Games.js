...
const getRefereedMatch = async (userID, sport, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/games/users/${userID}?sport=${sport}&role=referee`,
  authContext,
})
const getScorekeeperMatch = async (userID, sport, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/games/users/${userID}?sport=${sport}&role=scorekeeper`,
  authContext,
})

const deleteGameRecord = (gameId, recordId, authContext) => makeAPIRequest({
  method: 'delete',
  url: `${BASE_URL}games/${gameId}/records/${recordId}`,
  authContext,
});
...
const getGameFeed = async (game_id, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/newsfeeds?entity_type=game&entity_id=${game_id}`,
  authContext,
});

const getGameNextFeed = async (game_id, last_id, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/newsfeeds?entity_type=game&entity_id=${game_id}&id_lt=${last_id}`,
  authContext,
});
...
const getGameStatsChartData = async (userID, params, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/teams/${userID}/games/stats/chart`,
  params,
  authContext,
})
...
const getGameStatsData = async (userID, params, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/teams/${userID}/games/stats`,
  params,
  authContext,
})
...
const getGameMatchRecords = async (gameId, authContext, extraQuery) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/games/${gameId}/records?fetchTeamObject=true&${extraQuery}`,
  authContext,
})

const approveDisapproveGameRecords = (gameId, teamId, type = 'approve', params, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/teams/${teamId}/games/${gameId}/${type}`,
  data: params,
  authContext,
})
...
const patchGameReview = (gameId, reviewId, params, authContext) => makeAPIRequest({
  method: 'patch',
  url: `${BASE_URL}/games/${gameId}/reviews/${reviewId}`,
  data: params,
  authContext,
})
...
const addPlayerReview = (playerId, gameId, params, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}players/${playerId}/games/${gameId}/reviews`,
  data: params,
  authContext,
})
const patchPlayerReview = (playerId, gameId, reviewId, params, authContext) => makeAPIRequest({
  method: 'patch',
  url: `${BASE_URL}players/${playerId}/games/${gameId}/reviews/${reviewId}`,
  data: params,
  authContext,
})
const addRefereeReview = (refereeId, gameId, params, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}referees/${refereeId}/games/${gameId}/reviews`,
  data: params,
  authContext,
})
...
const patchRefereeReview = (refereeId, gameId, reviewID, params, authContext) => makeAPIRequest({
  method: 'patch',
  url: `${BASE_URL}referees/${refereeId}/games/${gameId}/reviews/${reviewID}`,
  data: params,
  authContext,
})
...
const addScorekeeperReview = (scorekeeperId, gameId, params, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}scorekeepers/${scorekeeperId}/games/${gameId}/reviews`,
  data: params,
  authContext,
})
...
const patchScorekeeperReview = (scorekeeperId, gameId, reviewID, params, authContext) => makeAPIRequest({
  method: 'patch',
  url: `${BASE_URL}scorekeepers/${scorekeeperId}/games/${gameId}/reviews/${reviewID}`,
  data: params,
  authContext,
})
