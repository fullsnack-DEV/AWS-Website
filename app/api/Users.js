...
export const checkTownscupEmail = (email) => apiCall({
  method: 'get',
  url: `${BASE_URL}/users/townscup?email=${email}`,
})
...
export const getGallery = (userID, authContext) => makeAPIRequest({
  method: 'get',
  url: `${BASE_URL}/players/${userID}/gallery/`,
  authContext,
});

export const followUser = (params, userID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/players/${userID}/follow`,
  data: params,
  authContext,
});
...
export const unfollowUser = (params, userID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/players/${userID}/unfollow`,
  data: params,
  authContext,
});
...
export const inviteUser = (params, userID, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/users/${userID}/invite`,
  data: params,
  authContext,
});
...
export const attachPaymentMethod = (params, authContext) => makeAPIRequest({
  method: 'post',
  url: `${BASE_URL}/payments/attachPaymentMethod`,
  data: params,
  authContext,
});
