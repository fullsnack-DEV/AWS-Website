...
const images = {
  ...
  newCreateGroupIcon: require('../assets/images/newCreateGroupIcon.png'),
  ...
  // new local home assets
  newTcLogo: require('../assets/images/TCicon.png'),
  challengeIcon: require('../assets/images/challengeIconlocallhome.png'),
  bookRefreeIcon: require('../assets/images/bookrefreelocalhome.png'),
  bookScoreKeeper: require('../assets/images/bookscorekeeperlocalhome.png'),
  eventIcon: require('../assets/images/eventlocalhome.png'),
  playerIconHome: require('../assets/images/playerImglocalhome.png'),
  scorekeeperIconHome: require('../assets/images/scorekeeperimglocalhome.png'),
  refreeIconHome: require('../assets/images/refreeimglocalhome.png'),
  createTemIconHome: require('../assets/images/creatteamlocalhome.png'),
  notificationBellHome: require('../assets/images/bellLocalHome.png'),
  allSportIcon: require('../assets/images/allsporticon.png'),
  editIconHome: require('../assets/images/editiconhome.png'),
  registerAsPlayerIcon: require('../assets/images/registerplayericon.png'),
  registerAsRefreeIcon: require('../assets/images/registerrefreeicon.png'),
  registerAsScoreKeeperIcon: require('../assets/images/regidtsterscorekeepericon.png'),
  createTeamIcon: require('../assets/images/createteamicon.png'),
  createClubIcon: require('../assets/images/createclubhomeicon.png'),
  createLeagueIcon: require('../assets/images/createleaguehomeicon.png'),
  joinTeamIcon: require('../assets/images/jointeamhomeicon.png'),
  joinClubIcon: require('../assets/images/joinclubhomeicon.png'),
  joinLeagueIcon: require('../assets/images/joinleaguehomeicon.png'),
  inviteMemberIcon: require('../assets/images/invitememberhomeicon.png'),
  invitememberbuttonicon: require('../assets/images/invitememberbuttonicon.png'),
  defaultPlayerBg: require('../assets/images/playerBG2.png'),
  teamdefaultbg: require('../assets/images/teamdefaultbg.png'),
  clubdefaultbg: require('../assets/images/Clubdefaultbg.png'),
  leagauedefaultbg: require('../assets/images/leaguedefaultbg.png'),
  curvecut: require('../assets/images/curvecutbg.png'),
  tcdefaultPlaceholder: require('../assets/images/TCdefaultIcon.png'),
